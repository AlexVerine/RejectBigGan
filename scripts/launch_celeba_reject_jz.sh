...
--test_every 5000 --save_every 1000 --num_best_copies 5 --num_save_copies 2 --seed 0   --num_epochs 1000 
...
--G_ch 32 --D_ch 32 \
--ema --use_ema --ema_start 2000 \
--test_every 5000 --save_every 1000 --num_best_copies 5 --num_save_copies 2 --seed 0   --num_epochs 1500 --resume --name_suffix finetune 
