...
--dataset I64_hdf5 --parallel --shuffle  --num_workers 4 --batch_size 512  --load_in_mem \
...
--G_eval_mode \
--G_ch 32 --D_ch 32 \
--ema --use_ema --ema_start 25000 \
--test_every 5000 --save_every 5000 --num_best_copies 5 --num_save_copies 2 --seed 0 \
--use_multiepoch_sampler --num_epochs 30   --which_best R 

# python launch_jeanzay.py \
# --dataset I64_hdf5 --parallel --shuffle  --num_workers 4 --batch_size 256  --load_in_mem \
# --num_G_accumulations 1 --num_D_accumulations 1 \
# --num_D_steps 1 --G_lr 1e-4 --D_lr 4e-4 --D_B2 0.999 --G_B2 0.999 \
# --G_attn 32 --D_attn 32 \
# --G_nl relu --D_nl relu \
...
#
# python launch_jeanzay.py \
# --dataset I64_hdf5 --parallel --shuffle  --num_workers 4 --batch_size 128  --load_in_mem \
