...
--shuffle --batch_size 50 --parallel \
--num_G_accumulations 1 --num_D_accumulations 1 --num_epochs 510   \
--num_D_steps 4 --G_lr 2e-50 --D_lr 1e-5 \
--dataset C10_hdf5 \
--G_ortho 0.0 \
--G_attn 0 --D_attn 0 \
--G_init N02 --D_init N02 \
--ema --use_ema --ema_start 1000 \
--test_every 10000 --save_every 5000 --num_best_copies 5 --num_save_copies 2 --seed 0 \
