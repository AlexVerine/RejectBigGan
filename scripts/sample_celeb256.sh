...
# python launch_jeanzay.py --mode sample --sample_random --sample_inception_metrics \
...
# --test_every 2000 --save_every 2000 --num_best_copies 2 --num_save_copies 5 --seed 0
...
--G_init N02 --D_init N02 \
--ema  --ema_start 5000 --G_eval_mode \
--test_every 2000 --save_every 2000 --num_best_copies 2 --num_save_copies 5 --seed 0  --resume_no_optim --name_suffix finetune_noopt \
--load_weights best1
...
# --G_init N02 --D_init N02 \
# --ema  --ema_start 5000 --G_eval_mode \
# --test_every 2000 --save_every 2000 --num_best_copies 2 --num_save_copies 5 --seed 0 --mem_constraint 32 --resume_no_optim --name_suffix finetune_noopt
#
# python launch_jeanzay.py \
# --which_loss PR --which_div Chi2 --lambda 2.0  \
# --shuffle --batch_size 128 --parallel --which_best P \
...
# python launch_jeanzay.py \
# --which_loss PR --which_div Chi2 --lambda 1.0  \
# --shuffle --batch_size 64 --parallel --which_best P+R \
# --num_G_accumulations 2 --num_D_accumulations 2 --num_epochs 400 \
# --num_D_steps 4 --G_lr 1e-5 --D_lr 1e-5 \
# --dataset CA256_hdf5 --load_in_mem --num_workers 4 \
# --G_ortho 0.0 \
...
# python launch_jeanzay.py \
# --which_loss PR --which_div Chi2 --lambda 2.0  \
# --shuffle --batch_size 64 --parallel --which_best P \
# --num_G_accumulations 2 --num_D_accumulations 2 --num_epochs 400 \
# --num_D_steps 4 --G_lr 1e-5 --D_lr 1e-5 \
# --dataset CA256_hdf5 --load_in_mem --num_workers 4 \
# --G_ortho 0.0 \
...
# python launch_jeanzay.py \
# --which_loss PR --which_div Chi2 --lambda 0.5  \
# --shuffle --batch_size 64 --parallel --which_best R \
# --num_G_accumulations 2 --num_D_accumulations 2 --num_epochs 400 \
# --num_D_steps 4 --G_lr 1e-5 --D_lr 1e-5 \
# --dataset CA256_hdf5 --load_in_mem --num_workers 4 \
# --G_ortho 0.0 \
